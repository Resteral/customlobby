...
public static class Utils
{
    ...
    {
        bool isBuilder = Building.GetBuilder(player) != null;
    ...
    public static bool HasPermission(CCSPlayerController player)
    {
        if (AdminManager.PlayerHasPermissions(player, "@css/root") ||
            ...
            AdminManager.PlayerHasPermissions(player, "@css/map"))
        {
            return true;
        }
    ...
    {
        player.PrintToChat(StringExtensions.ReplaceColorTags(config.Settings.Prefix + " " + message));
    }

    public static void PrintToChatAll(string message)
    {
        var formatted = StringExtensions.ReplaceColorTags(config.Settings.Prefix + " " + message);
    ...
    public static void PrintToChatAllOriginal(string message)
    {
