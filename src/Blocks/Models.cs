...
public partial class Blocks
{
    ...
    public class Models
    {
        ...
        public BlockCTFlag CTFlag { get; set; } = new();
        public BlockTFlag TFlag { get; set; } = new();
        public BlockFreezeLine FreezeLine { get; set; } = new();
            ...
            var allBlocks = new List<BlockModel>
        {
            ...
            NoFallDmg, Honey, Barrier, CTFlag, TFlag, FreezeLine
        };
    ...
    public class BlockCTFlag : BlockModel
    {
        public BlockCTFlag()
        {
            Title = "CT Flag";
    ...
    public class BlockTFlag : BlockModel
    {
        public BlockTFlag()
        {
            Title = "T Flag";
    ...
    public class BlockFreezeLine : BlockModel
    {
        public BlockFreezeLine()
        {
            Title = "Freeze Line";
            Block = "models/blockmaker/barrier/block.vmdl";
            Pole = "models/blockmaker/barrier/pole.vmdl";
