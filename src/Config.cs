...
public class Config_Settings
{
    ...
    public class Settings_Shop
    {
        public bool Enabled { get; set; } = true;
        public int BuilderPrice { get; set; } = 500;
        public List<string> BuyCommands { get; set; } = new() { "buybm", "buybuilder" };
    }
    public Settings_Shop Shop { get; set; } = new();
}
...
public class Config_Commands
{
    public class Commands_Admin
    {
        ...
        public List<string> Ghost { get; set; } = [ "ghost", "obs", "observer" ];
        public List<string> FreezeTag { get; set; } = [ "freezetag", "ft" ];
        public List<string> HideAndSeek { get; set; } = [ "hns", "hideandseek", "hs" ];
    }
...
{
    public string SoundEvents { get; set; } = ""; // No custom soundevents needed — using built-in CS2 sounds

    public class Sounds_Blocks
    {
        // These are real CS2 built-in sound paths — edit in BlockMaker.json to customise
        public string Speed        { get; set; } = "sounds/ambient/wind/wind_airy1.vsnd";
        public string Camouflage   { get; set; } = "sounds/ui/hint.vsnd";
        public string Damage       { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Fire         { get; set; } = "sounds/ambient/fire/fire_small1.vsnd";
        public string Health       { get; set; } = "sounds/ui/hint.vsnd";
        public string Invincibility{ get; set; } = "sounds/ui/hint.vsnd";
        public string Nuke         { get; set; } = "sounds/ambient/explosions/explode_4.vsnd";
        public string Stealth      { get; set; } = "sounds/ui/hint.vsnd";
        public string Teleport     { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Bhop         { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Delay        { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Gravity      { get; set; } = "sounds/ambient/wind/wind_airy1.vsnd";
        public string Grenade      { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Frost        { get; set; } = "sounds/ui/hint.vsnd";
        public string Flash        { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Death        { get; set; } = "sounds/ambient/explosions/explode_4.vsnd";
        public string SpeedBoost   { get; set; } = "sounds/ambient/wind/wind_airy1.vsnd";
        public string Slap         { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Trampoline   { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Honey        { get; set; } = "sounds/ui/hint.vsnd";
        public string Weapon       { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Barrier      { get; set; } = "sounds/ui/hint.vsnd";
    }
    ...
    {
        public bool   Enabled { get; set; } = true;
        public string Create  { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Delete  { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Place   { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Rotate  { get; set; } = "sounds/ui/menu_click.vsnd";
        public string Save    { get; set; } = "sounds/ui/hint.vsnd";
    }
